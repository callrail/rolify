...
5.3.1 is a CallRail internal patch for using `rolify` when there are
<tt>has_many... through</tt> definitions prior to its execution.

* Add <tt>association_foreign_key</tt> as valid option to main <tt>rolify</tt>
  class method
